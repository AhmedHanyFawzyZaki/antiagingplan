# Antiagingplan:
	...
	This a responsive website with payment gateway "e-junkie", it is built with a custom cms which allows the admin to fully manage and control the front-end.
