...
class SubscriberController extends AdminController {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow admin user to perform 'admin' and 'delete' actions
                'actions' => array('admin', 'delete','subscribersReport'),
                'users' => array('admin'),
            ),
    ...
    public function actionSubscribersReport() {
        $users = Subscriber::model()->findAll();
        if ($users) {

            Yii::import('ext.phpexcel.XPHPExcel');
            $objPHPExcel = XPHPExcel::createPHPExcel();
            $objPHPExcel->getProperties()->setCreator("PrettyLavish")
                    ->setLastModifiedBy("PrettyLavish")
                    ->setTitle("PrettyLavish")
                    ->setSubject("PrettyLavish")
                    ->setDescription("PrettyLavish")
                    ->setKeywords("PrettyLavish")
                    ->setCategory("PrettyLavish");
            ...
            $filename = "PrettyLavish-subscribers-" . date('j-M-Y');
