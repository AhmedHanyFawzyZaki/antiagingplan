...
class ArticleCommentController extends AdminController
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['ArticleComment'];
			if($model->save())
	...
	public function actionIndex()
	{
		...
		if(isset($_GET['id']))
		{
			Yii::app()->user->setState('art',$_GET['id']);
			$_GET['ArticleComment']['article_id']=Yii::app()->user->getState('art');
		}
		elseif(Yii::app()->user->getState('art')!='')
		{
			$_GET['ArticleComment']['article_id']=Yii::app()->user->getState('art');
		}
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='article-comment-form')
		{
