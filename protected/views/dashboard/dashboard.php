...
<ul class="shortcuts">
                            ...
                            <li class="archive">
                                 <a href="<?php echo Yii::app()->baseUrl; ?>/pages">
                                    ...
                                    <span class="shortcuts-label">Static Pages</span>
                                </a>
                            </li>
                            <!--<li class="help">
                            ...
                            <li class="help">
                                <a href="<?php echo Yii::app()->baseUrl; ?>/gallary">
                                    <span class="shortcuts-icon iconsi-help"></span>
                                    <span class="shortcuts-label">Manage Gallery</span>
                                </a>
                            </li>
                            <li class="help">
                                <a href="<?php echo Yii::app()->baseUrl; ?>/settings/contactUs">
                                    <span class="shortcuts-icon iconsi-help"></span>
                                    <span class="shortcuts-label">Manage Contact Us</span>
                                </a>
                            </li>
                            <!--<li class="help">
                                <a href="<?php echo Yii::app()->baseUrl; ?>/music">
                                    <span class="shortcuts-icon iconsi-help"></span>
                                    <span class="shortcuts-label">Manage Music</span>
                                </a>
                            </li>
                            <li class="help">
                                <a href="<?php echo Yii::app()->baseUrl; ?>/musicstore">
                                    <span class="shortcuts-icon iconsi-help"></span>
                                    <span class="shortcuts-label">Manage Music Store</span>
                                </a>
                           </li>-->
