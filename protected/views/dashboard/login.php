...
<div class="loginpanel">
    ...
    <!--<a href="<?php echo Yii::app()->request->baseUrl; ?>" style="color:white;font-size: 21px;">Fitness</a>-->
        <div class="logo animate0 bounceIn">
	
        <img src="<?=Yii::app()->request->baseUrl?>/media/<?=Settings::model()->findByPk('1')->image?>" alt="" /></div>
